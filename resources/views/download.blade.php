...
<head>
    <meta charset="utf-8" />
    <title>ACM Share &mdash; Sharing academic material is fun</title>
...
<nav class="navbar navbar-expand-lg py-lg-3 navbar-dark">
    <div class="container">
        ...
        <!-- logo -->
        <a href="{{url('/')}}" class="navbar-brand mr-lg-5">
            <div>
                <img src="/assets/images/index-logo.png"')}} alt="" class="logo-dark" height="38">
            </div>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <ul class="navbar-nav ml-auto align-items-center">
                <li class="nav-item mr-0">
                    <a href="{{route('register')}}" class="nav-link d-lg-none text-center">Register</a>
                    <a href="{{route('login')}}" class="nav-link d-lg-none text-center">Login</a>
                    <a href="{{route('register')}}" class="btn btn-success btn-rounded d-none d-lg-inline-flex">&nbsp; &nbsp; Register&nbsp; &nbsp;</a> &nbsp; &nbsp; &nbsp;
                    <a href="{{route('login')}}" class="btn btn-success btn-rounded d-none d-lg-inline-flex">&nbsp; &nbsp; Login&nbsp; &nbsp;</a>
                </li>
            </ul>
            ...
            <div class="col-md-5">
                <div class="mt-md-4">
                    ...
                    <h4 class="text-white font-weight-normal">
                        Academic Material Sharing Portal {AcMat}
                    </h4>
                    <br>
                    <p class="mb-4 font-16 text-white-50">This is a pet educational project aimed at improving students academic pursuit through
                        providing a plaform for sharing of past questions, research materials, etc.
                    </p>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="mt-5">
                        <p class="text-white-50 mt-4 text-center mb-0">© 2019 - 2020 Exco year</p>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        var post_title = '{{$material->name}}'
        var materialUrl = '{{route('download', $material->id)}}'
    ...
    $('#material-modal').on('hide.bs.modal', function(){
        location = '{{auth()->check()? route('home') : route('login')}}'
    });
