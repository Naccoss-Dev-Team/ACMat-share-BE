    ...
    <script>
        $(document).ready(function() {
            $('#material-modal').on('show.bs.modal', function (event) {
                ...
                // var materialUrl = button.data('deleteUrl')
        ...
        <div class="modal-dialog" role="">
            <div class="modal-content">
                <div class="modal-header bg-primary border-0">
                    <h5 class="modal-title" id="material-modal-label">Name</h5>
                ...
                <div class="text justify-text-center text-justify"">
                    <p class="text-muted text-justify">Share to social Media For Friends</p>
                </div>
{{--                <div class="d-flex ml-3 mb-3 w-25 justify-content-between">--}}
                ...
                <div class="row">
                    <div class="col-12">
                        <a href="#" class="w-100 btn btn-primary">Download</a>
                    </div>
                </div>
